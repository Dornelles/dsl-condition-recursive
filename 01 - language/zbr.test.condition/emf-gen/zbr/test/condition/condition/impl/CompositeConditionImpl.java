 ...
 * </p>
 * <ul>
 *   <li>{@link zbr.test.condition.condition.impl.CompositeConditionImpl#getConditions <em>Conditions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositeConditionImpl extends ConditionImpl implements CompositeCondition
{
	...
	{
		return ConditionPackage.Literals.COMPOSITE_CONDITION;
	}
	...
	public EList<Condition> getConditions()
	{
		if (conditions == null)
		{
			conditions = new EObjectContainmentEList<Condition>(Condition.class, this, ConditionPackage.COMPOSITE_CONDITION__CONDITIONS);
		}
		return conditions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case ConditionPackage.COMPOSITE_CONDITION__CONDITIONS:
