 ...
 * </p>
 * <ul>
 *   <li>{@link zbr.test.condition.condition.impl.ComparisonOperatorImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComparisonOperatorImpl extends MinimalEObjectImpl.Container implements ComparisonOperator
{
	...
	{
		return ConditionPackage.Literals.COMPARISON_OPERATOR;
	}
	...
	public void setSymbol(String newSymbol)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConditionPackage.COMPARISON_OPERATOR__SYMBOL, oldSymbol, symbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ConditionPackage.COMPARISON_OPERATOR__SYMBOL:
				return getSymbol();
		}
